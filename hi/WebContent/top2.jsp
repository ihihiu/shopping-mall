...
<!-- size, color 맞춰서 적어놓기 -->
    <div class="cont" id="cont1">
        ...
        <img src="image/top2_img1.jpg"  style="width:600px;height:700px;">
        <img src="image/top2_img2.jpg"  style="width:600px;height:800px;">
        <img src="image/top2_img3.jpg"  style="width:600px;height:800px;">
        <img src="image/top2_img4.jpg"  style="width:600px;height:800px;">
        <p style="margin-top:150px; margin-bottom:150px; font-size:17px; line-height: 30px;">
            size(cm)<br>
            총장74 어깨77 가슴71 암홀24 팔길이43 소매11 밑단56<br><br>
