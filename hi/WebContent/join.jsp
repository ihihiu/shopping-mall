       ...
       <div class="body">
        ...
        <div class="main">
         <p style="margin:0px 0px 20px 115px; font-size: 30px;">Register</p>
            <p style="margin-left:113px;color:red;margin-bottom:10px;">${error }</p>
            ...
            <table class="table" border="0">
                               ...
                               <tr>
                                   ...
                                   <input type="text" name="id" id="id" size="15" minlength="4" maxlength="16"  placeholder="4~15자리로 입력" required>
                                   </td>
                               </tr>
                               <tr>
                                   <td style="width: 170px; height: 45px; border-right: 0px;">&nbsp;패스워드</td>
                                   <td style="width: 550px; height: 45px; border-left:0px;">
                                   <input type="password" name="pwd" id=pwd size="15"  minlength="8" maxlength="16" size='30' placeholder="8~16자리로 입력" required>
                                   </td>
                               </tr>
                               ...
                               <tr>
                                   ...
                                   <td style="width: 550px; height: 45px; border-left:0px;">
                                   <input type="email" name="email" size="27"></td>           
                               </tr>
                               <tr>
                                   <td style="width: 170px; height: 45px; border-right: 0px;">&nbsp;전화번호</td>   
                                   <td style="width: 550px; height: 45px; border-left:0px;">
                                   <input type="text" name="phone" maxlength="12" size="20" required></td>          
                               </tr>            
                               <tr>
                                   <td style="width: 170px; height: 45px; border-right: 0px;">&nbsp;우편번호</td>            
                                   <td style="width: 550px; height: 45px; border-left:0px;">            
                                       <input type="text" name="zipcode"  minlength="5" maxlength="5" size="7" required>     
                                   </td>
                               </tr>            
                               <tr>           
                                   <td style="width: 150px; height: 45px; border-right: 0px;">&nbsp;주소</td>           
                                   <td style="width: 550px; height: 45px; border-left:0px;">
                                   <input type="text" name="address" size="60" required></td>           
                               </tr>
                               <tr>
                                <td colspan="2" style="text-align: right; border:0px">
                                    <!-- <input type="reset" value="CANCEL" id="btnclear"> -->
                                    <input type="submit" value="JOIN MEMBER" id="btnSubmit">
                                </td>
                            </tr>
            </table>
        </form>
