...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/tapmenustyle.css"><!--style.css 연결-->
...
<%
	...
	ClothesVO clothes=dao.getOneCloth(3);
...
<!-- size, color 맞춰서 적어놓기 -->
    <div class="cont" id="cont1">
        ...
        <img src="image/top3_img1.jpg"  style="width:600px;height:700px;">
        <img src="image/top3_img2.jpg"  style="width:600px;height:700px;">
        <img src="image/top3_img3.jpg"  style="width:600px;height:800px;">
        <img src="image/top3_img4.jpg"  style="width:600px;height:700px;">
        <p style="margin-top:150px; margin-bottom:150px; font-size:17px; line-height: 30px;">
            size(cm)<br>
            총장(끈포함)33 가슴32 암홀15.5 밑단27<br><br>
